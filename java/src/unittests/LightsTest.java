...
public class LightsTest {
    ...
    public void sphereAllLights() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Point3D(-50, 100, -50),
    ...
    @Test
    public void triangaleAllLights() {
    	  Scene scene = new Scene("Test scene");
          scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
          scene.setDistance(1000);
          scene.setBackground(Color.BLACK);
          ...
          scene.addLights(new SpotLight(new Color(500, 300, 0), new Point3D(-50, 0, -50),
                  new Vector(1, -1, 2), 1, 0.00001, 0.00000001),new PointLight(new Color(500, 250, 250),
                          new Point3D(10, 10, 130),
                          1, 0.0005, 0.0005),new DirectionalLight(new Color(100, 100, 100), new Vector(0, -1, -1)));
